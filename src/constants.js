...
import codfixLogo from './assets/work_logo/codefix.png';
...
import megamart from './assets/work_logo/megaMart.png';
  ...
  export const projects = [
    {
      ...
      title: "Mega-Mart",
      description:
        "Mega Mart is a modern Shopping Cart web application built with React and Redux Toolkit. The project uses Fake Store API to fetch and display product data dynamically. It includes features like product search with debouncing, category-based filtering, add/remove cart functionality, quantity management, and toast notifications using React Toastify.",
      image: megamart,
      tags: [
        "React JS",
        "Redux",
      ...
      github: "https://github.com/Rohanrai540/Mega-Mart",
      webapp: "https://mega-mart-liart.vercel.app/",
    },
    {
      id: 1,
    ...
    },
    {
      ...
      image: codfixLogo,
      tags: ["React JS", "CSS", "Gemini API", "HTML", "CSS", "JavaScript"],
    ...
    },
    {
      ...
      description:
        "A personal portfolio website built using React and CSS to showcase projects, skills, and experience. It features a clean, responsive design, smooth navigation, and interactive UI elements. The portfolio highlights development work, provides project details, and offers an easy way for recruiters and clients to connect and explore.",
      image: portfolioLogo,
      tags: ["React JS", "CSS", "HTML", "CSS", "JavaScript"],
      github: "https://github.com/Rohanrai540/Portfolio",
      webapp: "https://portfolio-rohan-rai-540.vercel.app/",
    },
    {
      id: 4,
